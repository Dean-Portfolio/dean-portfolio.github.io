...
const lines = [
  {
    ...
    node: (
      <h1 className="text-4xl leading-tight sm:text-5xl lg:text-6xl">
        <span className="text-gradient-brand">Dean Alfred Turing, PSM I | LSSGB</span>
      </h1>
    ),
  },
  {
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        >
          {badges.map((badge, i) => (
            <motion.li
              key={badge}
              className="inline-flex items-center rounded-full border border-primary/60 bg-card px-4 py-2 text-sm text-foreground"
        ...
        >
          <a
            href="#case-studies"
            className="bg-gradient-brand inline-flex cursor-pointer items-center justify-center rounded-lg px-6 py-3 text-sm font-semibold text-primary-foreground transition-all duration-300 hover:scale-105 hover:brightness-110 hover:shadow-[0_0_20px_rgba(6,182,212,0.5)]"
          >
            View Automated Systems
          </a>
          <a
            href="#contact"
            className="inline-flex cursor-pointer items-center justify-center rounded-lg border border-secondary px-6 py-3 text-sm font-semibold text-secondary transition-all duration-300 hover:scale-105 hover:bg-secondary hover:text-secondary-foreground"
          >
