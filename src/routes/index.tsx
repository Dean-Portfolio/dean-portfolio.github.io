    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "Person",
              name: "Dean Alfred Turing",
              jobTitle: "Systems Operations Specialist & AI / CRM Automation Architect",
              email: "mailto:hello@deanturing.com",
              description,
              knowsAbout: [
                "GoHighLevel",
                "Zapier",
            ...
            },
            {
              ...
              name: "Dean Alfred Turing — AI & CRM Automation Consulting",
              description,
              areaServed: "Worldwide",
              serviceType: "AI and CRM workflow automation consulting",
              email: "mailto:hello@deanturing.com",
            },
          ],
        }),
